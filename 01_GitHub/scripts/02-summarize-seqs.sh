...
# tip: tail -n +2 removes the header line
# tip 2: awk -v sample="$SAMPLE" -v OFS='\t' '{print sample, $2, $3, $4, $5, $6, $7, $8}' formats the output to include the sample name and tab-delimited fields
